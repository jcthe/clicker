...
function printText(text){ //one parameter called text and text is a parameter
    console.log(text);

}

printText('Happy Thursday!'); //argument 'yes' replaces parameter text

printText('Tomorrow is Friday!'); //argument 'no' replaces parameter text
